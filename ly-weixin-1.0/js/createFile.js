...
function CreateFile()
{
   ...
   tf = fso.CreateTextFile("G:\Loylecare\loyul\trunk\ly-weixin-1.0\js\test.txt", true);//创建一个文件夹
   // 写一行，并且带有新行字符。
...
function ManipFiles()
{
   ...
   f1 = fso.CreateTextFile("G:\Loylecare\loyul\trunk\ly-weixin-1.0\js\test.txt", true); //如果当前文件已经存在的话，则覆盖原有文件
